...
import org.codehaus.swizzle.confluence.Permission;
...
public class ConfluenceRedux {  
private final XmlRpcClient client;
private String token;
protected boolean sendRawData;

public ConfluenceRedux(String endpoint) throws MalformedURLException {
...
public Boolean importSpace(byte[] zip) throws SwizzleException, ConfluenceException {
